...
%%la concentración alcanza un máximo. t_cmax
...
%%Ahora para obtener A si la concentración máxima es 1.25 entonces debemos
%%despejar A
...
%%Se tiene que aplicar la segunda inyección cuando c_min = 0.15

c_min = 0.15;

f = @(t) (A * (t^alpha) * exp(-t/B) - c_min);

%%Obtener la raíz de la función por medio de newton
